        ...
        {!image && (
          <div className="flex h-full items-center justify-center flex-col gap-8">
            <div className="text-center">
              <h1 className="text-2xl font-bold tracking-tight sm:text-3xl">Reels Image Maker</h1>
              <p className="mt-2 text-sm text-muted-foreground">Ubah gambar jadi format vertikal 9:16 untuk Instagram Reels</p>
            </div>
